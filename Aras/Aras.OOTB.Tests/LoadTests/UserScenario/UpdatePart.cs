...
public class UpdatePart : IUserScenario {

    string IUserScenario.Description => "Edit Part";
    ...
    private Item EditPart(Item part) {
        part.setProperty("name", ArasTestBase.GetNewId());
        return part.apply("edit");
    }
